...
# -*- coding: utf-8 -*-
#
# metric-farmer documentation build configuration file, created by
...
htmlhelp_basename = 'metric-farmerdoc'
...
latex_documents = [
    (master_doc, 'metric-farmer.tex', 'metric-farmer Documentation',
...
man_pages = [
    (master_doc, 'metric-farmer', 'metric-farmer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'metric-farmer', 'metric-farmer Documentation',
     author, 'metric-farmer', 'One line description of project.',
     'Miscellaneous'),
]
